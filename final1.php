...
<div id="left-arrow3" >
      ...
      <div id="section1" style="height:280px;   background-image: url('content/ClipArt/back1.jpg'); border-radius: 7px;"><p style="width:500px; font-size: 35px; font-family:newWaltDisneyUI;  ">Upload Your Design</p> 
...
<p style="position:absolute; left:240px; bottom:210px; font-size: 35px;  font-family:newWaltDisneyUI; color: white; ">Duplicate Design</p>
<input  type="button" title="" style="display:none;" id="duplicate">
    <label for="duplicate" style="position: absolute; left:280px; bottom: 80px;"><img src="content/Icons/duplicate.png"  width="100px"  height="100px"></label>
...
canvas.on('object:selected', function (e) {
        ...
        e.target.borderColor = '#f44242';
        e.target.cornerColor = '#f4414d';
        e.target.minScaleLimit = 2;
        e.target.cornerStrokeColor = '#f4414d';
...
var HideControls = {
 ...
 var dataImage = [
  "https://cdn1.iconfinder.com/data/icons/streamline-interface/60/cell-8-10-120.png", /*scale*/
      ...
      "content/Icons/expand.png", /*Expand 6*/
      "content/Icons/arrow1.png",      /*Expand7 */
      "content/Icons/add.png",  /*duplicate 7*/
      "content/Icons/trash4.png",  /*trash 8 */
       "content/Icons/rotate6.png"  /*rotate */
  ];
//********override*****//
     ...
     switch (control)
            {
              ...
              SelectedIconImage.src = dataImage[0];
            case 'tl':/*delete*/
              SelectedIconImage.src = dataImage[9];
        break;
            case 'tr':/*scale*/
              SelectedIconImage.src = dataImage[7];   
        break;
            case 'bl':/*scale*/
             SelectedIconImage.src = dataImage[8];
        break;
            case 'br':/*rotate*/
              SelectedIconImage.src = dataImage[5];
        break;
            default:
...
//override prorotype _setCornerCursor to change the corner cusrors
  fabric.Canvas.prototype._setCornerCursor =  function(corner, target) {
    if (corner === 'tl' && target.hasRotatingPoint) {
      this.setCursor(this.rotationCursor);
      
      /*ADD*/
      }else if(corner == "br"){
        this.setCursor(this.resize); 
...
fabric.util.object.extend(fabric.Canvas.prototype, {  
   ...
   _setCornerCursor: function(corner, target) {      
     if ((corner === 'mtr' || corner === 'tl') && target.hasRotatingPoint) {
      ...
      clone.set({left: actObj.left+Math.random()*50,top: actObj.top+Math.random()*50});
        clone.setCoords();
        canvas.add(clone); 
        clone.setControlsVisibility(HideControls);
        canvas.renderAll();
        }
          }
        });
